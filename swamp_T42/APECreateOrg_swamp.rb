...
exp_hash.each{|hash|
  `cat ./APESolarDepSWPO-T42_ASolarConst_template.org | sed -e s/#__SolarConstTag__#/#{hash["dir"]}/g > APESolarDepSWPO-T42_#{hash["exp_tag"]}_sub.org`  
  `emacs24 --batch --no-site-file -l ~/.emacs --visit APESolarDepSWPO-T42_#{hash["exp_tag"]}.org --funcall org-html-export-to-html`
}
